...
: GameWorld(assetPath), numCitizensLeft(0)
{
}
...
void StudentWorld::addActorToList(int x, int y, Level::MazeEntry loc)
{
    ...
    switch(loc)
    {
        case Level::player: // found penelope
            m_penelope = new Penelope(gameX, gameY);
            break;
        case Level::empty:
            break;
        case Level::smart_zombie:
            m_actors.push_back(new SmartZombie(gameX, gameY));
            break;
        case Level::dumb_zombie:
            m_actors.push_back(new DumbZombie(gameX, gameY));
            break;
        case Level::exit:
            m_actors.push_back(new Exit(gameX, gameY));
            break;
        case Level::wall:
            m_actors.push_back(new Wall(gameX, gameY));
            break;
        case Level::pit:
            m_actors.push_back(new Pit(gameX, gameY));
            break;
        case Level::citizen:
            m_actors.push_back(new Citizen(gameX, gameY));
            break;
        case Level::vaccine_goodie:
            m_actors.push_back(new VaccineGoodie(gameX, gameY));
            break;
        case Level::gas_can_goodie:
            m_actors.push_back(new GasCanGoodie(gameX, gameY));
            break;
        case Level::landmine_goodie:
            m_actors.push_back(new LandmineGoodie(gameX, gameY));
    }
}
